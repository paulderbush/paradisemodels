...
const CATEGORIES = ["All Natural Escorts","British Escorts","Curvy Escorts","Roleplay Escorts","Bisexual Escorts","Brunette Escorts","Mature Escorts","Russian Escorts","Blonde Escorts","Busty Escorts","Party Girl Escorts","Striptease Escorts","Brazilian Escorts","Couples Escorts","Recommended Escorts","Ukrainian Escorts"];
...
const JULIA_DATA = {
  ...
  initials: 'JU',
  cats: ['All Natural Escorts', 'Blonde Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts', 'Ukrainian Escorts'],
...
const AIRA_DATA = {
  ...
  initials: 'AI',
  cats: ['Blonde Escorts', 'Busty Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Russian Escorts', 'Striptease Escorts'],
...
const ANASTASIIA_DATA = {
  ...
  initials: 'AN',
  cats: ['Bisexual Escorts', 'Brunette Escorts', 'Busty Escorts', 'Couples Escorts', 'Curvy Escorts', 'Mature Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts'],
...
const ELDORA_DATA = {
  ...
  initials: 'EL',
  cats: ['All Natural Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Bisexual Escorts', 'Striptease Escorts'],
...
const LUNA_DATA = {
  ...
  initials: 'LN',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Blonde Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Russian Escorts'],
...
const AVRORA_DATA = {
  ...
  color: ['rgba(180,60,90,0.4)', 'rgba(110,25,50,0.7)'],
  initials: 'AV',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Blonde Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Green', hairColor: 'Blonde', orientation: 'Bisexual',
  languages: 'English · Russian',
...
const PAVANA_DATA = {
  id: 9973, real: true, vip: true, folder: 'vip-models/Pavana', slug: 'pavana',
  name: 'Pavana', age: 23, height: 173,
  ...
  initials: 'AN',
  cats: ['All Natural Escorts', 'Blonde Escorts', 'Russian Escorts'],
  svcs: [],
  extraSvcs: [],
...
const BAYLA_DATA = {
  ...
  color: ['rgba(150,110,70,0.4)', 'rgba(90,60,30,0.7)'],
  initials: 'BA',
  cats: ['Brunette Escorts', 'All Natural Escorts', 'Russian Escorts'],
  svcs: [],
  extraSvcs: [],
...
const LEYLA_DATA = {
  ...
  initials: 'LE',
  cats: ['Brunette Escorts', 'Recommended Escorts'],
  svcs: [],
  extraSvcs: [],
...
const CELESTE_DATA = {
  id: 9951, real: true, vip: true, folder: 'vip-models/Celeste', slug: 'celeste',
  name: 'Celeste', height: 177,
  ...
  outcallRates: [],
  description: [
    "Winner of a beauty pageant, Celeste has appeared on magazine covers and in the pages of Vogue, and has walked the runway at Fashion Week as a professional model.",
  ],
  reviews: [],
};
...
const KOA_DATA = {
  ...
  initials: 'KO',
  cats: ['Brunette Escorts', 'Russian Escorts', 'Roleplay Escorts'],
...
const LIVIA_DATA = {
  ...
  nationality: 'Brazilian', city: 'Singapore',
...
const EMMA_DATA = {
  ...
  initials: 'EM',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
...
const ZENDAYA_DATA = {
  ...
  initials: 'ZE',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Busty Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts'],
...
const KETANA_DATA = {
  ...
  initials: 'KE',
  cats: ['All Natural Escorts', 'Blonde Escorts', 'Recommended Escorts', 'Bisexual Escorts', 'Party Girl Escorts', 'Russian Escorts'],
  svcs: [],
  extraSvcs: [],
  incallRates: [
    {label: '1 Hour', price: 1250},
...
const RACHEL_DATA = {
  ...
  initials: 'RA',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brunette Escorts', 'Busty Escorts', 'Couples Escorts', 'Curvy Escorts', 'Mature Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts'],
...
const GARUDA_DATA = {
  ...
  color: ['rgba(150,110,70,0.4)', 'rgba(90,60,30,0.7)'],
  initials: 'GA',
  cats: ['Brunette Escorts', 'All Natural Escorts', 'Brazilian Escorts', 'Party Girl Escorts', 'Striptease Escorts', 'Roleplay Escorts', 'Bisexual Escorts'],
...
const GELATO_DATA = {
  ...
  color: ['rgba(155,89,208,0.4)', 'rgba(100,40,160,0.7)'],
  initials: 'GE',
  cats: ['Russian Escorts', 'All Natural Escorts', 'Blonde Escorts', 'Striptease Escorts', 'Party Girl Escorts', 'Roleplay Escorts', 'Bisexual Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Blue', hairColor: 'Blonde', orientation: 'Bisexual',
...
const YOSHI_DATA = {
  ...
  color: ['rgba(80,20,150,0.4)', 'rgba(50,10,100,0.7)'],
  initials: 'YO',
  cats: ['Brazilian Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Brunette Escorts', 'Mature Escorts', 'Recommended Escorts', 'Striptease Escorts'],
...
const TAVRIA_DATA = {
  ...
  nationality: 'Ukrainian', city: 'Madrid',
  travelNote: 'Available to travel across Europe',
  rateHour: 1000, extraHourPrice: 600,
  color: ['rgba(160,180,70,0.4)', 'rgba(100,120,30,0.7)'],
  initials: 'TA',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Russian Escorts', 'Ukrainian Escorts'],
...
const LUMONA_DATA = {
  ...
  color: ['rgba(160,180,70,0.4)', 'rgba(100,120,30,0.7)'],
  initials: 'LU',
  cats: ['All Natural Escorts', 'Blonde Escorts', 'Brazilian Escorts'],
  breastType: 'Natural',
...
const EUPHORIA_DATA = {
  ...
  color: ['rgba(200,180,150,0.4)', 'rgba(130,110,80,0.7)'],
  initials: 'EU',
  cats: ['Blonde Escorts', 'Busty Escorts', 'Recommended Escorts'],
  svcs: [],
  extraSvcs: [],
  incallRates: [],
  outcallRates: [],
...
const CAMDICE_DATA = {
  ...
  color: ['rgba(155,89,208,0.4)', 'rgba(100,40,160,0.7)'],
  initials: 'CA',
  cats: ['All Natural Escorts', 'Blonde Escorts', 'Brazilian Escorts', 'Party Girl Escorts', 'Striptease Escorts', 'Roleplay Escorts'],
...
const ZOMELA_DATA = {
  ...
  color: ['rgba(200,160,60,0.4)', 'rgba(130,95,20,0.7)'],
  initials: 'ZO',
  cats: ['All Natural Escorts', 'Blonde Escorts', 'Brazilian Escorts', 'Party Girl Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Green', hairColor: 'Blonde', orientation: 'Bisexual',
...
const KARMELITA_DATA = {
  ...
  color: ['rgba(180,60,90,0.4)', 'rgba(110,25,50,0.7)'],
  initials: 'KA',
  cats: ['Brazilian Escorts', 'Busty Escorts', 'Brunette Escorts', 'Bisexual Escorts'],
...
const SAVANNAH_DATA = {
  ...
  initials: 'SA',
  cats: ['British Escorts', 'Brunette Escorts', 'All Natural Escorts', 'Party Girl Escorts', 'Striptease Escorts', 'Bisexual Escorts'],
...
const CAPA_DATA = {
  ...
  initials: 'CA',
  cats: ['Busty Escorts', 'Brazilian Escorts', 'Bisexual Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '8',
...
const COLENIA_DATA = {
  ...
  initials: 'CO',
  cats: ['Busty Escorts', 'Blonde Escorts', 'Brazilian Escorts', 'Bisexual Escorts'],
...
const IVY_DATA = {
  ...
  initials: 'IV',
  cats: ['All Natural Escorts', 'Blonde Escorts', 'Recommended Escorts', 'Russian Escorts'],
  svcs: [],
  extraSvcs: [],
  incallRates: [],
  outcallRates: [],
...
const CORESSA_DATA = {
  ...
  initials: 'CR',
  cats: ['All Natural Escorts', 'Brazilian Escorts', 'Party Girl Escorts', 'Striptease Escorts', 'Roleplay Escorts'],
  breastSize: '32A', breastType: 'Natural', clothingSize: '6',
...
const SHAE_DATA = {
  ...
  initials: 'SH',
  cats: ['Bisexual Escorts', 'Busty Escorts', 'Party Girl Escorts', 'Brazilian Escorts', 'Couples Escorts', 'Recommended Escorts'],
...
const DEBINI_DATA = {
  ...
  initials: 'DE',
  cats: ['Brazilian Escorts', 'Blonde Escorts', 'Busty Escorts', 'Striptease Escorts', 'Roleplay Escorts', 'Party Girl Escorts'],
...
const NEMUNA_DATA = {
  ...
  initials: 'NE',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Hazel', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Russian',
...
const ARIELLE_DATA = {
  ...
  initials: 'AR',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Russian Escorts'],
...
const TALISTA_DATA = {
  ...
  initials: 'TL',
  cats: ['Bisexual Escorts', 'Brunette Escorts', 'Couples Escorts', 'Mature Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts', 'Ukrainian Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '6',
  eyeColor: 'Hazel', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Russian · Ukrainian',
...
const DIAMOND_DATA = {
  ...
  initials: 'DI',
  cats: ['Brunette Escorts', 'Recommended Escorts', 'Party Girl Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '4',
  eyeColor: 'Blue', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Russian',
...
const APRILINA_DATA = {
  ...
  initials: 'AP',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Russian Escorts', 'Striptease Escorts'],
...
const MALAGA_DATA = {
  ...
  initials: 'MG',
  cats: ['Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '8',
  eyeColor: 'Green', hairColor: 'Light brown', orientation: 'Bisexual',
  languages: 'English · Portuguese',
...
const WEIZEL_DATA = {
  ...
  initials: 'WE',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Blonde Escorts', 'Brazilian Escorts', 'Couples Escorts', 'Mature Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '32B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Blue', hairColor: 'Blonde', orientation: 'Bisexual',
  languages: 'English · Portuguese',
...
const MEARA_DATA = {
  ...
  initials: 'MR',
  cats: ['All Natural Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Curvy Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
...
const ELARA_DATA = {
  ...
  initials: 'ER',
  cats: ['Bisexual Escorts', 'Brazilian Escorts', 'Couples Escorts', 'Blonde Escorts', 'Busty Escorts', 'Party Girl Escorts', 'Recommended Escorts'],
  breastSize: '34D', breastType: 'Enhanced', clothingSize: '8',
  eyeColor: 'Green', hairColor: 'Blonde', orientation: 'Bisexual',
  languages: 'English · Spanish · Portuguese',
...
const SAVANA_DATA = {
  ...
  initials: 'SN',
  cats: ['Bisexual Escorts', 'Busty Escorts', 'Party Girl Escorts', 'Blonde Escorts', 'Couples Escorts', 'Recommended Escorts', 'Russian Escorts', 'Striptease Escorts'],
...
const ALDARI_DATA = {
  ...
  initials: 'AK',
  cats: ['Russian Escorts', 'Brunette Escorts', 'Roleplay Escorts'],
...
const MERCURY_DATA = {
  ...
  initials: 'MU',
  cats: ['All Natural Escorts', 'Brazilian Escorts', 'Couples Escorts', 'Bisexual Escorts', 'Brunette Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
...
const MAINE_DATA = {
  ...
  initials: 'MN',
  cats: ['Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Mature Escorts', 'Party Girl Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '10',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
...
const BECCA_DATA = {
  ...
  initials: 'BC',
  cats: ['British Escorts', 'Blonde Escorts', 'Busty Escorts', 'Roleplay Escorts', 'Party Girl Escorts'],
...
const STELLARIA_DATA = {
  ...
  initials: 'ST',
  cats: ['Bisexual Escorts', 'Blonde Escorts', 'Brazilian Escorts', 'Striptease Escorts'],
  breastSize: '32B', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Green', hairColor: 'Blonde', orientation: 'Bisexual',
  languages: 'English · Italian · Portuguese',
...
const ALISA_DATA = {
  ...
  initials: 'AS',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Couples Escorts', 'Mature Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts'],
  breastSize: '34C', breastType: 'Natural', clothingSize: '6',
...
const AMANDA_DATA = {
  ...
  initials: 'MD',
  cats: ['Brazilian Escorts', 'Brunette Escorts', 'Busty Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Striptease Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Portuguese',
...
const KITTY_DATA = {
  ...
  initials: 'KI',
  cats: ['Blonde Escorts', 'Brazilian Escorts', 'Striptease Escorts'],
...
const HOLIKA_DATA = {
  ...
  initials: 'HO',
  cats: ['Bisexual Escorts', 'Busty Escorts', 'Mature Escorts', 'Recommended Escorts', 'Russian Escorts', 'Blonde Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
...
const EGERIA_DATA = {
  ...
  initials: 'EG',
  cats: ['Brazilian Escorts', 'Roleplay Escorts', 'Brunette Escorts', 'Striptease Escorts'],
...
const KELLY_DATA = {
  ...
  initials: 'KL',
  cats: ['Russian Escorts', 'Blonde Escorts', 'All Natural Escorts', 'Bisexual Escorts', 'Roleplay Escorts', 'Striptease Escorts', 'Party Girl Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Blue', hairColor: 'Blonde', orientation: 'Bisexual',
  languages: 'English · Russian',
...
const TEJANA_DATA = {
  ...
  initials: 'TJ',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Recommended Escorts', 'Striptease Escorts'],
  breastSize: '32B', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese · Spanish',
...
const VENTANA_DATA = {
  ...
  initials: 'VE',
  cats: ['Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Busty Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Striptease Escorts'],
  breastSize: '34D', breastType: 'Enhanced', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Spanish · Portuguese',
...
const COLIEN_DATA = {
  ...
  initials: 'CI',
  cats: ['Bisexual Escorts', 'Couples Escorts', 'Brazilian Escorts', 'Mature Escorts'],
  breastSize: '36C', breastType: 'Enhanced', clothingSize: '8',
  eyeColor: 'Green', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
...
const VALESKA_DATA = {
  ...
  initials: 'VA',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Brazilian Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
...
const ENRIKETA_DATA = {
  ...
  initials: 'EN',
  cats: ['Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Curvy Escorts', 'Party Girl Escorts', 'Recommended Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese · Spanish',
...
const SVETLANA_DATA = {
  ...
  initials: 'SL',
  cats: ['Bisexual Escorts', 'Brunette Escorts', 'Busty Escorts', 'Couples Escorts', 'Curvy Escorts', 'Mature Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Russian Escorts', 'Striptease Escorts'],
...
const YUNITA_DATA = {
  ...
  initials: 'YU',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Blonde Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts'],
...
const ZERIVA_DATA = {
  ...
  initials: 'ZR',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brazilian Escorts', 'Busty Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '34D', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Redhead', orientation: 'Bisexual',
  languages: 'English · Spanish · Portuguese',
...
const MANZANA_DATA = {
  ...
  color: ['rgba(200,90,70,0.4)', 'rgba(140,40,20,0.7)'],
  initials: 'NZ',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '36B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
...
const BAILEY_DATA = {
  ...
  initials: 'BY',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Russian Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Russian',
...
const PHYLLIS_DATA = {
  ...
  initials: 'PH',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Blonde Escorts', 'Brazilian Escorts', 'Couples Escorts'],
  breastSize: '32B', breastType: 'Natural', clothingSize: '8',
...
const AISHA_DATA = {
  ...
  initials: 'AH',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Recommended Escorts', 'Russian Escorts'],
  breastSize: '32B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Russian · Ukrainian',
...
const YAROSLAVA_DATA = {
  ...
  initials: 'YA',
  cats: ['All Natural Escorts', 'Blonde Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Russian Escorts'],
  breastSize: '32B', breastType: 'Natural', clothingSize: '8',
...
const CHAVELA_DATA = {
  ...
  initials: 'CH',
  cats: ['Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Busty Escorts', 'Couples Escorts', 'Curvy Escorts', 'Party Girl Escorts', 'Striptease Escorts'],
...
const IEVA_DATA = {
  ...
  color: ['rgba(150,110,190,0.4)', 'rgba(90,50,140,0.7)'],
  initials: 'IE',
  cats: ['Busty Escorts', 'Brunette Escorts', 'Mature Escorts', 'Striptease Escorts', 'Party Girl Escorts', 'Russian Escorts'],
...
const ANNA_DATA = {
  ...
  initials: 'NN',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Russian Escorts', 'Recommended Escorts'],
...
const ANGELINA_DATA = {
  ...
  initials: 'AE',
  cats: ['All Natural Escorts', 'Recommended Escorts', 'Brunette Escorts', 'Russian Escorts'],
  orientation: 'Heterosexual',
  languages: 'Russian · English · Italian',
  svcs: [],
  extraSvcs: [],
...
const FRANCHE_DATA = {
  ...
  initials: 'FA',
  cats: ['Blonde Escorts', 'Recommended Escorts', 'Bisexual Escorts'],
...
const ANDREA_DATA = {
  ...
  initials: 'AF',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Russian Escorts', 'Bisexual Escorts'],
...
const GUMMI_DATA = {
  ...
  initials: 'GM',
  cats: ['Brazilian Escorts', 'Brunette Escorts', 'Party Girl Escorts'],
...
const JUTURNA_DATA = {
  ...
  initials: 'JT',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Busty Escorts', 'Roleplay Escorts'],
  breastSize: '34D', breastType: 'Natural', clothingSize: '10',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
...
const ENGRACIA_DATA = {
  ...
  initials: 'EA',
  cats: ['Brazilian Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
...
const RADA_DATA = {
  ...
  initials: 'RD',
  cats: ['Blonde Escorts', 'Russian Escorts', 'Striptease Escorts'],
...
const REPRISE_DATA = {
  ...
  initials: 'RE',
  cats: ['Brazilian Escorts', 'Brunette Escorts', 'Striptease Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '8',
  eyeColor: 'Green', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Portuguese',
...
const AIZERE_DATA = {
  ...
  initials: 'KZ',
  cats: ['Brunette Escorts', 'Mature Escorts', 'Russian Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '6',
...
const VANILLA_DATA = {
  ...
  initials: 'VN',
  cats: ['Brazilian Escorts', 'Busty Escorts', 'Party Girl Escorts', 'Striptease Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Blonde', orientation: 'Heterosexual',
  languages: 'English · Portuguese',
...
const DELMAR_DATA = {
  ...
  initials: 'DM',
  cats: ['All Natural Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Roleplay Escorts'],
  breastSize: '34C', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Portuguese',
...
const MALATI_DATA = {
  ...
  initials: 'MQ',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '10',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
...
const MINOLA_DATA = {
  ...
  initials: 'MC',
  cats: ['Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Roleplay Escorts'],
...
const OPHELIA_DATA = {
  ...
  color: ['rgba(160,110,100,0.4)', 'rgba(100,50,40,0.7)'],
  initials: 'OP',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Russian Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Russian',
...
const AIGERIM_DATA = {
  ...
  initials: 'AJ',
  cats: ['Bisexual Escorts', 'Couples Escorts', 'Russian Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '6',
...
const EMILY_DATA = {
  ...
  color: ['rgba(210,110,90,0.4)', 'rgba(150,50,30,0.7)'],
  initials: 'EY',
  cats: ['Brazilian Escorts', 'Party Girl Escorts', 'Striptease Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '8',
...
const KUGISAKI_DATA = {
  ...
  initials: 'KU',
  cats: ['Bisexual Escorts', 'Brazilian Escorts', 'Party Girl Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '32B', breastType: 'Enhanced', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Redhead', orientation: 'Bisexual',
  languages: 'English · Portuguese',
...
const BERMUDA_DATA = {
  ...
  color: ['rgba(220,200,120,0.4)', 'rgba(160,140,50,0.7)'],
  initials: 'BU',
  cats: ['Blonde Escorts', 'Brazilian Escorts', 'Party Girl Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '6',
...
const TUMAR_DATA = {
  id: 9804, real: true, vip: false, folder: 'models/Tumar', slug: 'tumar',
  name: 'Tumar', age: 25, height: 158, weight: 49,
  nationality: 'Brazilian', station: 'High Street Kensington', city: 'London',
  color: ['rgba(170,120,100,0.4)', 'rgba(110,60,40,0.7)'],
  initials: 'TU',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Curvy Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '34A', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Portuguese · Spanish',
  svcs: ['69', 'Toys', 'Face sitting', 'FK', 'GFE', 'Light domination', 'Massage', 'OWC', 'Spanking giving', 'Striptease', 'Uniforms'],
  extraSvcs: [
    {name: 'COB', price: 30},
    {name: 'OWO', price: 50},
    {name: 'Filming with mask', price: 250},
    {name: 'Filming without mask', price: 350},
  ],
  incallRates: [
    {label: '1 Hour', price: 300},
    {label: '90 Min', price: 450},
  ...
  description: [
    "With her soft brunette hair and sweet, captivating smile, Tumar is the kind of girl who instantly catches every eye in the room. Standing at a delicate 158 cm, she radiates charm and vibrant energy, making her presence both inviting and unforgettable. Her natural beauty and gentle warmth make her someone you can't help but be drawn to.",
    "Adored by many, Tumar's popularity is no accident — she knows exactly how to keep the atmosphere playful, exciting, and full of chemistry. Her schoolgirl uniforms add a tempting touch of fantasy, giving each encounter a deliciously mischievous edge. Every moment with her feels like a secret you'll want to keep… but also can't stop thinking about.",
    "If you're looking for a truly special experience with one of the most sought-after companions, Tumar is ready to make it happen. She's here to turn your day into something unforgettable.",
  ],
  reviews: [],
};

const MALKY_DATA = {
  id: 9803, real: true, vip: false, folder: 'models/Malky', slug: 'malky',
  name: 'Malky', age: 26, height: 165, weight: 50,
  nationality: 'Brazilian', station: 'Knightsbridge', city: 'London',
  color: ['rgba(190,140,110,0.4)', 'rgba(130,80,50,0.7)'],
  initials: 'MB',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brunette Escorts', 'Couples Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '32C', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese · Spanish',
  svcs: ['COB', 'DFK', 'DT', 'Erotic massage', 'Face sitting', 'FK', 'GFE', 'Lapdancing', 'Light domination', 'Massage', 'MMF for double price', 'OWC', 'OWO', 'Soft spanking receiving', 'Spanking giving', 'Striptease', 'Tie and Tease'],
  extraSvcs: [
    {name: 'CIF', price: 50},
    {name: 'CIM', price: 50},
    {name: 'WS giving', price: 50},
  ...
  description: [
    "There's something effortlessly captivating about Malky. With her natural beauty and sincere, grounded presence, she draws you in from the first glance. Everything about her feels real — from her soft skin to her feminine curves and expressive eyes. She's the kind of woman who doesn't need anything extra to stand out; her quiet confidence and warm aura do all the work.",
    "Malky is known for offering a service that stands out for all the right reasons. Thoughtful, sensual, and deeply engaging, she creates a space where you feel both desired and at ease. She takes her time, listens, and gives her full attention to every moment, ensuring that nothing feels rushed or routine. Her natural intuition and gentle charm make each encounter unique.",
    "If you're looking for someone who brings both beauty and authenticity, Malky is an experience worth savoring. She's here to give you her best — and she truly means it.",
  ],
  reviews: [],
};

const ESTEVA_DATA = {
  id: 9802, real: true, vip: false, folder: 'models/Esteva', slug: 'esteva',
  name: 'Esteva', age: 24, height: 162, weight: 50,
  nationality: 'Brazilian', station: 'High Street Kensington', city: 'London',
  color: ['rgba(160,110,100,0.4)', 'rgba(100,50,40,0.7)'],
  initials: 'ET',
  cats: ['Brazilian Escorts', 'Brunette Escorts', 'Busty Escorts', 'Party Girl Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '34D', breastType: 'Enhanced', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Portuguese',
  svcs: ['69', 'Body to body massage', 'COB', 'DFK', 'DT', 'Erotic massage', 'Toys', 'Face sitting', 'Fingering', 'FK', 'Foot fetish', 'GFE', 'Handcuffs', 'Light domination', 'Massage', 'OWC', 'Party girl', 'Poppers', 'PSE', 'Rimming receiving', 'Roleplay', 'Soft spanking receiving', 'Spanking giving', 'Strap-on', 'Striptease', 'Uniforms'],
  extraSvcs: [
    {name: 'OWO', price: 50},
    {name: 'CIF', price: 50},
    {name: 'WS giving', price: 60},
  ...
  description: [
    "Esteva is a captivating Brazilian brunette whose striking curves and confident presence make her impossible to ignore. Petite at 162 cm, she combines a delicate silhouette with a glamorous enhanced 34D figure, creating a look that is both seductive and elegantly feminine. Her deep brown eyes and dark hair add warmth and intensity to her naturally magnetic charm.",
    "With her refined style and bold confidence, Esteva effortlessly blends sophistication with playful allure. Her tattoos and subtle piercings give her appearance a modern, edgy touch, perfectly balancing her soft beauty with a hint of daring individuality. Every detail about her reflects confidence, sensuality, and an irresistible sense of self-expression.",
    "Warm, passionate, and full of vibrant Brazilian energy, Esteva brings excitement and charm into every encounter. Speaking Portuguese and English, she creates a relaxed and engaging atmosphere that feels both personal and unforgettable. Elegant yet adventurous, she offers a presence that is alluring, lively, and truly memorable.",
  ],
  reviews: [],
};

const DAMITA_DATA = {
  id: 9801, real: true, vip: false, folder: 'models/Damita', slug: 'damita',
  name: 'Damita', age: 21, height: 165, weight: 50,
  nationality: 'Brazilian', station: "St. James's Park", city: 'London',
  color: ['rgba(200,150,170,0.4)', 'rgba(140,90,110,0.7)'],
  initials: 'DT',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Couples Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '32B', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
  svcs: ['69', 'Body to body massage', 'COB', 'DFK', 'Dirty talk', 'DP', 'DT', 'Toys', 'Face sitting', 'FK', 'Foot fetish', 'GFE', 'Group for extra price', "Lady's services", 'Light domination', 'Massage', 'MMF for double price', 'OWC', 'Prostate massage', 'Rimming receiving', 'Roleplay', 'Soft spanking receiving', 'Spanking giving', 'Striptease', 'Uniforms'],
  extraSvcs: [
    {name: 'OWO', price: 50},
    {name: 'CIF', price: 50},
    {name: 'WS giving', price: 50},
  ...
  description: [
    "Damita is a radiant Brazilian beauty whose warm energy and natural elegance make her instantly captivating. With her soft brunette hair, warm brown eyes, and slender figure, she carries a fresh and effortlessly feminine charm. Standing at 165 cm with a delicate silhouette, she combines sophistication with a playful, modern allure that leaves a lasting impression.",
    "Naturally beautiful with no tattoos, Damita embraces a refined and polished appearance that highlights her graceful features and confident presence. Her subtle piercings add a touch of personality and individuality, perfectly complementing her elegant style. Every detail about her feels balanced, authentic, and irresistibly inviting.",
    "Beyond her beauty, Damita is warm, engaging, and full of vibrant Brazilian energy. Fluent in both Portuguese and English, she connects easily and naturally, creating a relaxed and memorable atmosphere wherever she goes. Her open-minded spirit and charming personality make every encounter feel exciting, effortless, and uniquely personal.",
  ],
  reviews: [],
};

const MEGREZ_DATA = {
  id: 9800, real: true, vip: false, folder: 'models/Megrez', slug: 'megrez',
  name: 'Megrez', age: 25, height: 157, weight: 64,
  nationality: 'Brazilian', station: 'Baker Street', city: 'London',
  color: ['rgba(200,140,110,0.4)', 'rgba(140,80,50,0.7)'],
  initials: 'MF',
  cats: ['Bisexual Escorts', 'Brunette Escorts', 'Busty Escorts', 'Couples Escorts', 'Curvy Escorts', 'Party Girl Escorts', 'Striptease Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '10',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
  svcs: ['69', 'COB', 'DFK', 'Toys', 'FK', 'Foot fetish', 'GFE', 'Light domination', 'Massage', 'OWC', 'Party girl', 'Striptease'],
  extraSvcs: [
    {name: 'OWO', price: 50},
    {name: 'A-Level', price: 100},
    {name: 'Bi DUO', price: 150},
  ...
  description: [
    "Megrez is a fiery Brazilian brunette, petite and irresistible at 157 cm, with a toned figure and a perky C-cup bust that adds to her magnetic appeal. Her exotic beauty is captivating — from her sultry gaze to the playful curves that invite your hands and attention. There's a wild sparkle in her eyes that hints she's always ready for something thrilling.",
    "A true party girl with an adventurous soul, Megrez thrives on excitement and connection. She brings a spirited, uninhibited energy to every encounter. Whether you're into teasing build-ups or intense satisfaction, she knows how to keep things hot, fun, and unforgettable from start to finish.",
    "If you're in the mood for a high-energy experience with a daring, sensual beauty, Megrez is ready to take you there. Open-minded and always in the mood to explore, she's the spark you didn't know you needed.",
  ],
  reviews: [],
};

const ISMAT_DATA = {
  id: 9799, real: true, vip: false, folder: 'models/Ismat', slug: 'ismat',
  name: 'Ismat', age: 21, height: 172, weight: 67,
  nationality: 'Brazilian', station: 'Bond Street', city: 'London',
  color: ['rgba(160,110,110,0.4)', 'rgba(100,50,50,0.7)'],
  initials: 'IM',
  cats: ['Bisexual Escorts', 'Brunette Escorts', 'Couples Escorts', 'Curvy Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '10',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
  svcs: ['69', 'COB', 'DFK', 'DT', 'Toys', 'Face sitting', 'FK', 'Foot fetish', 'GFE', 'Handcuffs', 'Light domination', 'Massage', 'MMF for double price', 'OWC', 'Prostate massage', 'Rimming receiving', 'Soft spanking receiving', 'Spanking giving', 'Strap-on', 'Striptease'],
  extraSvcs: [
    {name: 'OWO', price: 50},
    {name: 'WS giving', price: 50},
    {name: 'Rimming giving', price: 50},
  ...
  description: [
    "Ismat is a striking Brazilian brunette whose dark, expressive eyes and tattoos speak of passion, confidence, and irresistible curiosity. Her slender figure moves like a dancer, effortlessly captivating in every step, especially when she teases with an intimate striptease.",
    "She's a fearless fantasy-giver, open-minded and daring, ready to explore desire without limits. From foot worship and sensual domination with a strap-on, to playful restraint with handcuffs, Ismat thrives on creating unforgettable, intense experiences tailored exactly to your needs. With her, nothing is too bold — everything is possible.",
    "Let Ismat lead you into a world where no fantasy is too extreme and no pleasure is out of reach. If you're ready to surrender to someone wickedly creative and wildly uninhibited, your search ends here.",
  ],
  reviews: [],
};

const KOLACHELLA_DATA = {
  id: 9798, real: true, vip: false, folder: 'models/Kolachella', slug: 'kolachella',
  name: 'Kolachella', age: 25, height: 165, weight: 52,
  nationality: 'Brazilian', city: 'London',
  color: ['rgba(170,120,100,0.4)', 'rgba(110,60,40,0.7)'],
  initials: 'KC',
  cats: ['Brunette Escorts', 'Busty Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '6',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Spanish',
  svcs: ['69', 'Body to body massage', 'COB', 'DFK', 'Dirty talk', 'Erotic massage', 'Toys', 'Fingering', 'FK', 'Foot fetish', 'GFE', 'Lapdancing', 'Light domination', 'Massage', 'MMF for double price', 'OWC', 'OWO', 'Party girl', 'Prostate massage', 'PSE', 'Rimming receiving', 'Roleplay', 'Soft spanking receiving', 'Spanking giving', 'Squirting', 'Striptease', 'Uniforms'],
  extraSvcs: [
    {name: 'CIF', price: 50},
    {name: 'WS giving', price: 50},
    {name: 'Rimming giving', price: 50},
  ...
  description: [
    "Kolachella is a captivating Brazilian beauty with a refined and effortlessly feminine presence. Standing at 165 cm with a slender 52 kg figure, she embodies elegance and natural confidence. Her soft brown hair and warm brown eyes create a harmonious, inviting look that feels both gentle and alluring.",
    "Her enhanced curves complement her silhouette beautifully, adding a touch of glamour to her polished appearance. With no smoking or piercings and only a small tattoo, Kolachella maintains a clean and sophisticated image while still expressing a hint of individuality. She carries herself with poise, blending softness with a subtle, confident charm.",
    "Hetero and open in her energy, Kolachella connects easily thanks to her warm personality and good communication skills. Fluent in English and Spanish, she feels comfortable in international settings, bringing Brazilian warmth and elegance into every interaction. Her presence is calm, engaging, and quietly unforgettable.",
  ],
  reviews: [],
};

const REBECCA_DATA = {
  id: 9797, real: true, vip: false, folder: 'models/Rebecca', slug: 'rebecca',
  name: 'Rebecca', age: 27, height: 165, weight: 76,
  nationality: 'British', city: 'Dubai',
  color: ['rgba(160,110,100,0.4)', 'rgba(100,50,40,0.7)'],
  initials: 'RB',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brunette Escorts', 'Busty Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Recommended Escorts'],
  breastSize: '32DD', breastType: 'Natural', clothingSize: '10',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English',
  svcs: ['69', 'Bi DUO', 'Body to body massage', 'CIM', 'COB', 'DFK', 'Dirty talk', 'Domination', 'DT', 'Erotic massage', 'Toys', 'Face sitting', 'Filming with mask', 'Fingering', 'FK', 'Foot fetish', 'GFE', 'Handcuffs', 'Light domination', 'Massage', 'MMF', 'MMF for double price', 'OWC', 'OWO', 'Party girl', 'Poppers', 'PSE', 'Rimming giving', 'Rimming receiving', 'Roleplay', 'Soft spanking receiving', 'Spanking giving', 'Striptease', 'Tie and Tease', 'WS giving'],
  extraSvcs: [],
  incallRates: [
    {label: '1 Hour', price: 1600},
    {label: '90 Min', price: 1900},
    {label: '2 Hours', price: 2200},
    {label: '3 Hours', price: 3150},
  ],
  outcallRates: [
    {label: '1 Hour', price: 1600},
    {label: '90 Min', price: 1900},
  ...
  description: [
    "Rebecca embodies that rare kind of British beauty that instantly commands attention — refined, luminous, and effortlessly seductive. Her soft gaze, graceful features, and impeccable sense of style turn every glance into an invitation. She's the kind of woman who doesn't just walk into a room — she transforms it, leaving behind an aura of mystery and allure.",
    "Behind her striking looks lies a woman of presence and poise. Rebecca is elegant yet engaging, sensual yet sophisticated — a balance that makes her one of Dubai's most sought-after companions. Whether it's a private dinner or a night of pure indulgence, she knows how to make every encounter feel exclusive and unforgettable.",
    "For those who appreciate true class wrapped in irresistible beauty, Rebecca is the definition of temptation refined. A meeting with her isn't just an experience — it's a privilege waiting to be enjoyed.",
  ],
  reviews: [],
};

const ANGEL_DATA = {
  id: 9796, real: true, vip: true, folder: 'vip-models/Angel', slug: 'angel',
  name: 'Angel', age: 20, height: 160, weight: 46,
  clothingSize: 'XS', breastSize: '32B', breastType: 'Natural',
  eyeColor: 'Green', hairColor: 'Light Brown', orientation: 'Bisexual',
  nationality: 'Brazilian/Japanese', station: 'Chelsea', city: 'London',
  languages: 'English · Italian · Portuguese',
  ...
  extraSvcs: [
    ...
    {name: 'CIF', price: 100},
    {name: 'Snowballing', price: 100},
    {name: 'Swallow', price: 200},
    {name: 'A-Level', price: 600},
  ],
  incallRates: [
    {label: '1 Hour', price: 1000},
    {label: '90 Min', price: 1400},
  ...
  description: [
    "Angel is a radiant beauty with a natural charm that feels refreshingly pure and sincere. With soft light-brown hair framing her face and expressive green eyes, she carries a warmth that instantly captivates. Her graceful silhouette and elegant presence make her poised and effortlessly enchanting.",
    "Completely natural, with clean skin and no tattoos or piercings, Angel represents authenticity in its most beautiful form. Every detail about her feels harmonious and refined, from her subtle features to the calm confidence she radiates. She embodies a soft femininity that is both timeless and modern, appealing through simplicity rather than excess.",
    "With roots in Brazil and Japan, Angel blends cultures into a unique and unforgettable identity. This rich background reflects in her open spirit and warm energy, making her easy to connect with and impossible to forget. She is the kind of presence that feels light, genuine, and soothing — a true natural muse with an elegant soul.",
  ],
  reviews: [],
};

const EMILIE_DATA = {
  id: 9795, real: true, vip: true, folder: 'vip-models/Emilie', slug: 'emilie',
  name: 'Emilie', age: 23, height: 167, weight: 50,
  clothingSize: '6', breastSize: '34B', breastType: 'Natural',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  nationality: 'American/Korean', city: 'Miami',
  languages: 'English · French',
  ...
  description: [
    "Emilie is a refined and naturally elegant beauty with a truly international aura. At 23, she embodies a unique blend of American confidence and Korean grace, shaped by a life lived across Los Angeles, Geneva, and Paris. Standing at 167 cm with an all-natural look, she radiates effortless sophistication and understated charm.",
    "Her soft features and graceful presence reflect both her multicultural background and artistic sensibility. As a part-time fashion model and Art Business student, Emilie carries a deep appreciation for aesthetics, culture, and expression. She moves with quiet confidence, her style minimal yet impactful, always leaving a lasting impression without excess.",
    "Fluent in English and French, Emilie connects with ease and intelligence, bringing depth into every conversation. Her interests in pilates and spirituality reflect a balanced, mindful lifestyle, adding a calm and grounded energy to her presence. Elegant, cultured, and naturally captivating, Emilie is a woman who inspires through both beauty and intellect.",
  ],
  reviews: [],
};

const MAYA_DATA = {
  id: 9794, real: true, vip: true, folder: 'vip-models/Maya', slug: 'maya',
  name: 'Maya', age: 25, height: 181, weight: 73,
  clothingSize: '8', breastSize: '34D', breastType: 'Enhanced',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  nationality: 'British', city: 'Dubai',
  languages: 'English',
  ...
  extraSvcs: [
    {name: 'CIF', price: 100},
    {name: 'WS giving', price: 600},
  ],
  incallRates: [
    {label: '1 Hour', price: 700},
    {label: '90 Min', price: 1000},
    {label: '2 Hours', price: 1300},
    {label: '3 Hours', price: 1900},
    {label: 'Extra Hour', price: 600},
    {label: 'Overnight', price: 3500},
  ],
  outcallRates: [
  ...
  description: [
    "Maya is the embodiment of refined British beauty, carrying herself with elegance and confidence that immediately draws attention. Her athletic physique, sculpted to perfection, highlights every curve and detail, while her natural allure is enhanced by a full D bust that gives her a striking, glamorous silhouette. Every glance at her radiates a sense of luxury and exclusivity, the kind that makes her presence unforgettable.",
    "With Maya, encounters take on a rare quality — she combines sophistication with a vibrant, sensual energy that makes time spent together both thrilling and deeply memorable. Her sporty lifestyle lends her an aura of vitality, while her polished manners and exquisite taste make her a true luxury companion for the most discerning clientele.",
  ],
  reviews: [],
};

const VERA_DATA = {
  id: 9793, real: true, vip: false, folder: 'models/Vera', slug: 'vera',
  name: 'Vera', age: 24, height: 170, weight: 58,
  nationality: 'Russian', city: 'Moscow',
  travelNote: 'Available to travel to Dubai and London',
  color: ['rgba(150,180,140,0.4)', 'rgba(80,120,70,0.7)'],
  initials: 'VR',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Green', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'Russian · English',
  svcs: ['69', 'COB', 'DFK', 'Dinner Dates', 'Dirty talk', 'Domination', 'DT', 'Erotic massage', 'Face sitting', 'Fetish', 'Fingering', 'FK', 'Foot fetish', 'GFE', 'Lapdancing', 'Light domination', 'OWC', 'OWO', 'Party girl', 'Rimming receiving', 'Roleplay', 'Shower together', 'Spanking giving', 'Striptease', 'Tie and Tease'],
  extraSvcs: [
    {name: 'Rimming giving', price: 100},
    {name: 'Fisting receiving', price: 100},
    {name: 'A-Level', price: 150},
  ],
  incallRates: [],
  outcallRates: [
...
const LEYSAN_DATA = {
  ...
  initials: 'YL',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Russian',
...
// Temporarily paused (she's unwell) — deliberately left out of the MODELS
// array below (search for "VERADUBAI_DATA" in that array) so she drops out
// of the VIP catalog/search/sitemap/homepage teasers without losing her
// data. Re-add her to the MODELS array (and module.exports, where she's
// still listed) to bring her back.
...
const EMANUELLA_DATA = {
  ...
  initials: 'NM',
  cats: ['Brazilian Escorts', 'Brunette Escorts', 'Party Girl Escorts', 'Striptease Escorts'],
...
const ALESIA_DATA = {
  ...
  initials: 'IA',
  cats: ['Brunette Escorts', 'Busty Escorts', 'Curvy Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts'],
  svcs: [],
  extraSvcs: [
    {name: 'CIF', price: 200},
    {name: 'CIM (Includes OWO)', price: 200},
...
const ALPHINA_DATA = {
  id: 9769, real: true, vip: false, folder: 'models/Alphina', slug: 'alphina',
  name: 'Alphina', age: 18, height: 165, weight: 50,
  nationality: 'Ukrainian', station: "Earl's Court", city: 'London',
  color: ['rgba(150,170,210,0.4)', 'rgba(80,100,150,0.7)'],
  initials: 'LP',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Ukrainian Escorts'],
  breastSize: '34C', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Blue', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Russian · Ukrainian',
  svcs: ['69', 'COB', 'DFK', 'Face sitting', 'FK', 'Foot fetish', 'GFE', 'Group for extra price', 'Light domination', 'Massage', 'MMF for double price', 'OWO', 'Party girl', 'Poppers', 'Rimming receiving', 'Roleplay', 'Soft spanking receiving', 'Spanking giving'],
  extraSvcs: [
    {name: 'CIF', price: 50},
    {name: 'CIM (Includes OWO)', price: 50},
    {name: 'Prostate massage', price: 50},
  ...
  description: [
    "Alphina is a stunning Ukrainian beauty whose natural elegance and charm make her instantly unforgettable. Standing at 165 cm with a graceful 34C figure, she combines soft femininity with effortless sophistication. Her rich brunette hair and striking blue eyes create a captivating contrast, giving her a refined and naturally radiant appearance.",
    "Completely natural, with no tattoos or piercings, Alphina embodies classic beauty in its purest form. Her soft features, slender silhouette, and poised presence create an image of timeless elegance that never feels forced. She carries herself with quiet confidence and grace, making every encounter feel relaxed, genuine, and memorable.",
    "With her warm personality and sophisticated charm, Alphina leaves a lasting impression wherever she goes. Her natural poise and maturity create a presence that feels both refreshing and refined. Elegant, authentic, and effortlessly captivating, Alphina represents beauty, grace, and modern femininity at its finest.",
  ],
  reviews: [],
};

const BIANCA_DATA = {
  id: 9768, real: true, vip: false, folder: 'models/Bianca', slug: 'bianca',
  name: 'Bianca', age: 25, height: 180, weight: 59,
  nationality: 'Italian', station: 'Baker Street', city: 'London',
  color: ['rgba(190,150,120,0.4)', 'rgba(130,80,50,0.7)'],
  initials: 'BC',
  cats: ['Brunette Escorts', 'Busty Escorts', 'Mature Escorts'],
  breastSize: '34D', breastType: 'Enhanced', clothingSize: '8',
  eyeColor: 'Hazel', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Italian',
  svcs: ['69', 'A-Level', 'Bi DUO', 'CIM', 'Dirty talk', 'Couples', 'Toys', 'FK', 'Foot fetish', 'GFE', 'Latex outfit', 'Massage', 'OWO', 'Party girl', 'Roleplay', 'Strap-on'],
  extraSvcs: [
    {name: 'CIM', price: 100},
    {name: 'Bi DUO', price: 200},
    {name: 'A-Level', price: 300},
    {name: 'Strap-on', price: 300},
    {name: 'Couples', price: 500},
  ],
  incallRates: [
    {label: '1 Hour', price: 1000},
    {label: '90 Min', price: 1300},
  ...
  description: [
    "Bianca is a striking Italian beauty who brings warmth, elegance and playful confidence to every encounter. Standing at 180 cm with a curvy 59 kg figure, she has a commanding presence that turns heads the moment she walks in. Her rich brunette hair and warm hazel eyes give her a naturally magnetic look that's both sophisticated and inviting.",
    "Her enhanced curves are perfectly complemented by her tall, statuesque frame, giving her an unmistakably glamorous silhouette. With no tattoos or piercings and a clean, polished image, Bianca carries herself with the kind of effortless confidence that comes from knowing exactly who she is.",
    "Fluent in English and Italian, and open in her orientation, Bianca connects easily and puts everyone at ease with her warm, engaging personality. Based near Baker Street in central London, she's the ideal companion for anyone looking for a genuinely memorable evening with a woman who combines Italian charm with real sophistication.",
  ],
  reviews: [],
};

const AVRELIA_DATA = {
  id: 9765, real: true, vip: false, folder: 'models/Avrelia', slug: 'avrelia',
  name: 'Avrelia', age: 22, height: 172, weight: 52,
  nationality: 'Russian', station: 'Kensington High Street', city: 'London',
  color: ['rgba(150,110,90,0.4)', 'rgba(90,60,40,0.7)'],
  initials: 'AV',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Brunette Escorts', 'Couples Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '8',
  eyeColor: 'Brown', hairColor: 'Brown', orientation: 'Bisexual',
  languages: 'English · Russian',
  svcs: ['69', 'Bi DUO', 'COB', 'DFK', 'Dirty talk', 'DT', 'Toys', 'Face sitting', 'Fingering', 'FK', 'Foot fetish', 'GFE', 'Light domination', 'Massage', 'OWC', 'OWO', 'Prostate massage', 'Roleplay', 'Soft spanking receiving', 'Striptease'],
  extraSvcs: [
    {name: 'Couples', price: 200},
  ],
  incallRates: [
  ...
  description: [
    "Avrelia is a stunning 22-year-old Russian beauty whose elegance and natural charm captivate from the very first glance. With her silky brown hair and warm brown eyes, she radiates a quiet, refined sensuality that feels both innocent and deeply alluring. Her slender figure, standing gracefully at 172 cm, moves with effortless poise — every step a subtle dance of femininity and confidence.",
    "There's something timeless about Avrelia — the way she smiles softly, the way her presence fills a room without a single word. She's gentle yet magnetic, carrying an aura of calm that draws you closer. Her natural beauty needs no embellishment; it shines through in every glance, every gesture, every breath she takes.",
    "With Avrelia, connection feels easy and genuine. She's warm, intuitive, and knows how to create an atmosphere that's both soothing and thrilling. Whether you're sharing quiet moments or exploring deeper desires, she makes everything feel natural, elegant, and unforgettable.",
  ],
  reviews: [],
};

const ANGELICA_DATA = {
  id: 9766, real: true, vip: false, folder: 'models/Angelica', slug: 'angelica',
  name: 'Angelica', age: 26, height: 174, weight: 50,
  nationality: 'Czech', station: 'Knightsbridge', city: 'London',
  color: ['rgba(210,190,120,0.4)', 'rgba(150,120,40,0.7)'],
  initials: 'AG',
  cats: ['Bisexual Escorts', 'Blonde Escorts', 'Busty Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Recommended Escorts', 'Roleplay Escorts', 'Russian Escorts', 'Striptease Escorts'],
  breastSize: '32E', breastType: 'Enhanced', clothingSize: '6',
  eyeColor: 'Green', hairColor: 'Blonde', orientation: 'Bisexual',
  languages: 'English · Russian · Czech',
  svcs: ['69', 'Bi DUO', 'Body to body massage', 'CIF', 'CIM', 'COB', 'DFK', 'Dinner Dates', 'Dirty talk', 'Domination', 'DT', 'Erotic massage', 'Couples', 'Toys', 'Face sitting', 'Fetish', 'Fingering', 'FK', 'Foot fetish', 'GFE', 'Lapdancing', 'Light domination', 'Massage', 'MMF for double price', 'Party girl', 'PSE', 'Roleplay', 'Soft spanking receiving', 'Spanking giving', 'Striptease', 'Tie and Tease'],
  extraSvcs: [],
  incallRates: [
    {label: '1 Hour', price: 1000},
    {label: '90 Min', price: 1300},
  ...
  description: [
    "Angelica is a charming, seductive blonde bombshell with mesmerizing eyes who loves to have a great time. Her gorgeous body and beautiful face will entice you.",
    "What makes her exceptional is that she knows how to use her incredible assets to please and surprise every gentleman she spends time with. Angelica is 5'7 with a stunning figure, and it is no wonder she is a standout in every social gathering. She is definitely one of the best high-class escorts in London. Moreover, she is a smart party lover, available 24/7 and open-minded, which makes her great at any conversation, she is any gentleman's dream.",
    "Book Angelica today and we can assure you you will have a great time.",
  ],
  reviews: [],
};

const EMANUELLALONDON_DATA = {
  id: 9767, real: true, vip: false, folder: 'models/Emanuella', slug: 'emanuella-london',
  name: 'Emanuella', age: 22, height: 165, weight: 51,
  nationality: 'Brazilian', station: 'Mayfair', city: 'London',
  color: ['rgba(200,160,100,0.4)', 'rgba(140,100,40,0.7)'],
  initials: 'EM',
  ...
  eyeColor: 'Brown', hairColor: 'Brunette', orientation: 'Heterosexual',
  languages: 'English · Spanish · Portuguese',
  svcs: ['69', 'Bi DUO', 'Body to body massage', 'CIF', 'CIM', 'COB', 'DFK', 'Dirty talk', 'Domination', 'DT', 'Erotic massage', 'Toys', 'Face sitting', 'Filming with mask', 'Fisting giving', 'FK', 'Foot fetish', 'Group for extra price', "Lady's service", 'Lapdancing', 'Massage', 'MMF', 'MMF for double price', 'OWC', 'OWO', 'Party girl', 'Prostate massage', 'PSE', 'Rimming receiving', 'Roleplay', 'Squirting', 'Strap-on', 'Striptease', 'Tie and Tease', 'WS giving', 'WS receiving'],
  extraSvcs: [
    {name: 'FK', price: 100},
    {name: 'Tie and Tease', price: 200},
    {name: 'Fisting giving', price: 200},
  ...
  description: [
    "A captivating 22-year-old Brazilian beauty, she embodies youthful elegance, natural charm, and effortless sophistication. Standing at 165 cm with a slender, feminine silhouette, she radiates confidence and grace. Her expressive brown eyes and silky black hair create a timeless and striking beauty, perfectly complemented by her polished sense of style and warm personality.",
    "Blessed with natural curves and a flawless appearance free from tattoos and piercings, she represents classic femininity with a modern touch. Her refined presentation, graceful manners, and understated glamour make her presence both captivating and unforgettable.",
    "Fluent in Portuguese, English, and Spanish, she effortlessly connects with people from diverse cultures and backgrounds. Friendly, attentive, and naturally charismatic, she combines vibrant Brazilian warmth with elegance and sophistication. Her genuine charm, confidence, and refined demeanor ensure every encounter is memorable and truly exceptional.",
  ],
  reviews: [],
...
const POLINA_DATA = {
  id: 9764, real: true, vip: true, folder: 'vip-models/Polina', slug: 'polina',
  name: 'Polina', age: 23, height: 167, weight: 53,
  measurements: '90-63-98', clothingSize: 'XS', breastType: 'Natural',
  eyeColor: 'Green/Blue', hairColor: 'Light Blonde', orientation: 'Heterosexual',
  nationality: 'Ukrainian', city: 'New York',
  languages: 'Russian · English',
  color: ['rgba(155,89,208,0.4)', 'rgba(100,40,160,0.7)'],
  initials: 'PO',
  cats: ['Blonde Escorts', 'Ukrainian Escorts'],
  svcs: [],
  extraSvcs: [],
  incallRates: [],
  outcallRates: [],
...
const CRELIA_DATA = {
  id: 9763, real: true, vip: false, folder: 'models/Crelia', slug: 'crelia',
  name: 'Crelia', age: 20, height: 174, weight: 50,
  nationality: 'Brazilian/German', station: 'Marylebone', city: 'London',
  color: ['rgba(200,170,140,0.4)', 'rgba(140,100,60,0.7)'],
  initials: 'CR',
  cats: ['All Natural Escorts', 'Bisexual Escorts', 'Blonde Escorts', 'Couples Escorts', 'Party Girl Escorts', 'Roleplay Escorts', 'Striptease Escorts'],
  breastSize: '34B', breastType: 'Natural', clothingSize: '6',
  eyeColor: 'Hazel', hairColor: 'Blonde', orientation: 'Bisexual',
  languages: 'English · German · Portuguese',
  svcs: ['69', 'Bi DUO', 'Body to body massage', 'CIF', 'CIM', 'COB', 'DFK', 'Couples', 'Toys', 'Face sitting', 'FK', 'Foot fetish', 'GFE', "Lady's service", 'Lapdancing', 'Light domination', 'Massage', 'MMF', 'MMF for double price', 'OWC', 'OWO', 'Party girl', 'Rimming receiving', 'Roleplay', 'Soft spanking receiving', 'Striptease', 'Tie and Tease', 'Uniform schoolgirl', 'Uniform teacher', 'WS giving', 'WS receiving'],
  extraSvcs: [],
  incallRates: [
    {label: '1 Hour', price: 600},
    {label: '90 Min', price: 800},
  ...
  description: [
    "Crelia is a mesmerizing Brazilian–German beauty whose youthful energy and striking elegance make her truly unforgettable. With light-brown hair, glowing hazel eyes, and a graceful 174 cm frame, she moves with effortless allure — every step and glance radiating natural confidence and soft temptation. Her beauty is pure yet daring, a perfect harmony of innocence and intrigue.",
    "Playful by nature and open-minded at heart, Crelia brings an irresistible spark to every encounter. She's adventurous, curious, and unafraid to explore connection in all its forms. Her natural 34B curves and smooth skin only enhance the magnetic warmth she exudes — the kind that makes you want to know her deeper, to feel her laughter, her energy, her touch.",
    "Fluent in the language of passion, Crelia blends her Brazilian fire with German sophistication. Whether it's gentle intimacy or something more daring, she turns every moment into something vibrant and real. Confident and endlessly seductive — Crelia is the kind of fantasy that feels alive.",
  ],
  reviews: [],
};

const MIZONA_DATA = {
  id: 9762, real: true, vip: false, folder: 'models/Mizona', slug: 'mizona',
  name: 'Mizona', age: 28, height: 165, weight: 60,
  nationality: 'Brazilian', station: 'Battersea', city: 'London',
  color: ['rgba(190,140,110,0.4)', 'rgba(130,80,50,0.7)'],
  initials: 'MZ',
  cats: ['Bisexual Escorts', 'Brazilian Escorts', 'Brunette Escorts', 'Striptease Escorts'],
  breastSize: '34C', breastType: 'Enhanced', clothingSize: '8',
  eyeColor: 'Green', hairColor: 'Brunette', orientation: 'Bisexual',
  languages: 'English · Portuguese',
  svcs: ['69', 'Bi DUO', 'CIF', 'COB', 'DFK', 'DT', 'FK', 'Foot fetish', 'GFE', 'Group for extra price', 'Massage', 'OWO', 'Rimming giving', 'Rimming receiving', 'Striptease'],
  extraSvcs: [
    {name: 'CIF', price: 50},
    {name: 'Bi DUO', price: 100},
  ],
  ...
  description: [
    "At 28 years old, she has a naturally captivating presence, combining feminine elegance with a confident and sophisticated style. Standing at 165 cm with a graceful figure, brunette hair, and striking green eyes, she has a warm yet alluring appearance that is effortlessly memorable.",
    "Brazilian by nationality, she speaks fluent English and Portuguese, making her comfortable and engaging in international company. Her polished appearance and easy communication style allow her to adapt naturally to different settings, whether enjoying a relaxed conversation or a more refined evening.",
    "With her confident personality, exotic Brazilian charm, and distinctive green eyes, she offers a beautiful balance of sophistication and approachability. Her feminine look, outgoing nature, and international background make her an intriguing and versatile companion.",
  ],
  reviews: [],
};

const GALE_DATA = {
  id: 9761, real: true, vip: true, folder: 'vip-models/Gale', slug: 'gale',
  name: 'Gale', age: 25, height: 175, weight: 54,
  clothingSize: '6', breastSize: '34B', breastType: 'Natural',
  eyeColor: 'Green', hairColor: 'Light Brunette', orientation: 'Heterosexual',
  nationality: 'Russian', city: 'London',
  languages: 'English · Russian',
  color: ['rgba(160,190,150,0.4)', 'rgba(90,130,80,0.7)'],
  initials: 'GA',
  cats: ['Blonde Escorts', 'Recommended Escorts', 'Russian Escorts'],
  svcs: [],
  extraSvcs: [],
  incallRates: [
    {label: '1 Hour', price: 1600},
  ...
  description: [
    "At 25 years old, she is a stunning Russian beauty standing at an impressive 175 cm, with a slim and graceful figure. Her light brunette hair and striking green eyes create a fresh, elegant look, while her natural beauty gives her an effortlessly sophisticated appearance.",
    "Fluent in both Russian and English, she is confident communicating in an international environment and has a naturally warm and engaging personality. Her understated style, combined with her graceful presence, makes her comfortable in both relaxed and more refined settings.",
    "With her tall silhouette, delicate features, and captivating green eyes, she has an elegant yet approachable charm. Her confident personality and international outlook make her a memorable companion with a distinctive and sophisticated presence.",
  ],
  reviews: [],
};

const ANNANEWYORK_DATA = {
  id: 9760, real: true, vip: false, folder: 'models/Ana', slug: 'anna-new-york',
  name: 'Anna', age: 24, height: 171, weight: 54,
  nationality: 'Russian/Georgian', city: 'New York',
  color: ['rgba(200,190,150,0.4)', 'rgba(140,130,60,0.7)'],
  initials: 'AN',
  cats: ['Blonde Escorts', 'Russian Escorts'],
  breastType: 'Natural', clothingSize: 'XS',
  eyeColor: 'Blue-Green', hairColor: 'Blonde', orientation: 'Bisexual',
  languages: 'Russian · English',
  svcs: [],
  extraSvcs: [],
...
const LUCIA_DATA = {
  id: 9759, real: true, vip: true, folder: 'vip-models/Lucia', slug: 'lucia',
  name: 'Lucia', age: 23, height: 165,
  breastType: 'Natural',
  hairColor: 'Brunette',
  nationality: 'Italian', city: 'Milan',
  ...
  svcs: [],
  extraSvcs: [],
  // Client gave "$1000 per hour" — converted to GBP at roughly USD->GBP 0.79
  // (data/models.js stores every price in GBP; re-check this conversion if
  // the client meant an exact GBP figure).
  incallRates: [{label: '1 Hour', price: 790}],
  outcallRates: [{label: '1 Hour', price: 790}],
  description: [],
  reviews: [],
};

const NERO_DATA = {
  id: 9758, real: true, vip: true, folder: 'vip-models/Nero', slug: 'nero',
  name: 'Nero', age: 24, height: 173, weight: 55,
  clothingSize: '6', breastType: 'Natural',
  eyeColor: 'Brown', hairColor: 'Brown', orientation: 'Bisexual',
  nationality: 'American', city: 'New York',
  languages: 'English',
  color: ['rgba(170,130,100,0.4)', 'rgba(110,70,40,0.7)'],
  initials: 'NE',
  cats: ['Bisexual Escorts', 'Brunette Escorts'],
  svcs: [],
  extraSvcs: [],
  // Client gave outcall-only rates in USD ($1,800 / $2,200 / $1,500 /
  // $10,000) — converted to GBP at roughly USD->GBP 0.79 (data/models.js
  // stores every price in GBP; re-check this conversion if the client
  // meant exact GBP figures).
  incallRates: [],
  outcallRates: [
    {label: '1 Hour', price: 1420},
    {label: '90 Min', price: 1740},
    {label: 'Extra Hour', price: 1185},
    {label: 'Overnight', price: 7900},
  ],
  description: [],
  reviews: [],
};
...
const MARTINA_DATA = {
  id: 9757, real: true, vip: true, folder: 'vip-models/Martina', slug: 'martina',
  name: 'Martina', age: 23, height: 172, weight: 50,
  clothingSize: 'S', breastSize: '34C', breastType: 'Silicone',
  eyeColor: 'Brown', hairColor: 'Brown', orientation: 'Heterosexual',
  nationality: 'Italian', city: 'Milan',
  languages: 'Italian · French · English',
  color: ['rgba(180,140,160,0.4)', 'rgba(120,80,110,0.7)'],
  initials: 'MA',
  cats: ['Brunette Escorts', 'Party Girl Escorts'],
  svcs: ['69', 'FK', 'DFK', 'GFE', 'OWO', 'OWC', 'COB', 'DT', 'Fingering', 'Party girl', 'Face sitting', 'Smoking fetish', 'Foot fetish', 'Open minded', 'Light domination'],
  extraSvcs: [
    {name: 'CIF', price: 250},
    {name: 'WS giving', price: 500},
    {name: 'Rimming giving', price: 500},
...
const TORY_DATA = {
  id: 9756, real: true, vip: true, folder: 'vip-models/Tory', slug: 'tory',
  name: 'Tory', age: 21, height: 170, weight: 53,
  clothingSize: 'S', breastSize: '34B', breastType: 'Natural',
  eyeColor: 'Blue', hairColor: 'Blonde', orientation: 'Heterosexual',
  nationality: 'Slovenian', city: 'Zurich',
  languages: 'Slovenian · English · German · Russian',
  color: ['rgba(150,180,200,0.4)', 'rgba(80,120,150,0.7)'],
  initials: 'TO',
  cats: ['Blonde Escorts', 'Russian Escorts'],
  svcs: [],
  extraSvcs: [],
...
const JAZMINE_DATA = {
  id: 9755, real: true, vip: true, folder: 'vip-models/Jazmine', slug: 'jazmine',
  ...
  svcs: [],
  extraSvcs: [],
  // Client gave rates in EUR (€800 / €1k / €500 / €2000) — converted to GBP
  // at roughly EUR->GBP 0.87 (data/models.js stores every price in GBP;
  // re-check this conversion if the client meant exact GBP figures).
  incallRates: [
    {label: '1 Hour', price: 695},
    {label: '90 Min', price: 870},
    {label: 'Extra Hour', price: 435},
    {label: 'Overnight', price: 1740},
  ],
  outcallRates: [
    {label: '1 Hour', price: 695},
    {label: '90 Min', price: 870},
...
const KETIA_DATA = {
  id: 9754, real: true, vip: true, folder: 'vip-models/Ketia', slug: 'ketia',
  name: 'Ketia', age: 26, height: 170, weight: 63,
  clothingSize: 'S', breastSize: '34D', breastType: 'Natural',
  eyeColor: 'Green', hairColor: 'Black', orientation: 'Bisexual',
  nationality: 'Italian', city: 'Milan',
  languages: 'Italian · English · Spanish',
  color: ['rgba(140,170,120,0.4)', 'rgba(80,110,60,0.7)'],
  initials: 'KE',
  cats: ['Bisexual Escorts', 'Mature Escorts', 'Brunette Escorts', 'Recommended Escorts'],
  svcs: [],
  extraSvcs: [],
  incallRates: [
    {label: '1 Hour', price: 1000},
    {label: '90 Min', price: 1500},
    {label: 'Extra Hour', price: 2000},
    {label: 'Overnight', price: 6000},
  ],
  outcallRates: [
    {label: '1 Hour', price: 1000},
...
const MANUELLA_DATA = {
  id: 9753, real: true, vip: false, folder: 'models/Manuella', slug: 'manuella',
  name: 'Manuella', age: 24, height: 170, weight: 53,
  nationality: 'Polish', city: 'Warsaw',
  color: ['rgba(150,170,210,0.4)', 'rgba(80,110,160,0.7)'],
  initials: 'MN',
  cats: ['Busty Escorts', 'Blonde Escorts', 'Recommended Escorts'],
  breastType: 'Silicone', clothingSize: '4',
  eyeColor: 'Blue', hairColor: 'Blonde', orientation: 'Heterosexual',
  languages: 'English · Dutch · Polish · Russian (basic)',
  svcs: ['OWO', 'CIF', 'COB', '69', 'Massage', 'Couples', 'GFE', 'Threesome'],
  extraSvcs: [],
  incallRates: [
    {label: '1 Hour', price: 1400},
    {label: '90 Min', price: 2000},
    {label: 'Overnight', price: 4900},
  ],
  outcallRates: [
    {label: '1 Hour', price: 1400},
    {label: '90 Min', price: 2000},
...
const TARA_DATA = {
  id: 9752, real: true, vip: true, folder: 'vip-models/Tara', slug: 'tara',
  name: 'Tara', age: 26, height: 168, weight: 48,
  breastType: 'Natural',
  eyeColor: 'Blue', hairColor: 'Brown', orientation: 'Heterosexual',
  city: 'Los Angeles',
  travelNote: 'Available to travel across the USA',
  color: ['rgba(180,150,120,0.4)', 'rgba(120,90,60,0.7)'],
  initials: 'TA',
  cats: ['All Natural Escorts', 'Brunette Escorts', 'Recommended Escorts'],
  svcs: [],
  extraSvcs: [],
